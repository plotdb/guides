...
| 模組 | 功能 | 文件 |
|------|------|------|
| `@makeform/common` | 所有 widget 共用的基礎 block；含 term 編輯器（驗證條件 UI） | [common/index.md](common/index.md) |
| `@makeform/radio` | 單選 widget | [radio/index.md](radio/index.md) |
| `@makeform/checkbox` | 多選 checkbox widget | [checkbox/index.md](checkbox/index.md) |
| `@makeform/choice` | 下拉/選項 widget（支援多選、搜尋、其它選項） | [choice/index.md](choice/index.md) |
